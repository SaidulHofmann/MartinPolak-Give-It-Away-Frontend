...
import {PermissionItemComponent} from '../permission/permission-item/permission-item.component';
...
export class UserComponent implements OnInit, AfterViewInit, CanDeactivate<CanComponentDeactivate> {
